...
class EditUserDialogMobile extends StatefulWidget {
  UserModel userModel;
  EditUserDialogMobile({required this.userModel});
  @override
  _EditUserDialogMobileState createState() => _EditUserDialogMobileState();
}

class _EditUserDialogMobileState extends State<EditUserDialogMobile> {
            ...
            builder: (context, state) {
              if (state is UserValidationStatus) {
                return state.username.isNotEmpty
                    ? WarningBarMobile(text: state.username)
                    : Container();
              } else {
                return Container();
              }
                    ...
                    builder: (context, state) {
                      if (state is UserValidationStatus) {
                        return state.password.isNotEmpty
                            ? WarningBarMobile(text: state.password)
                            : Container();
                      } else {
                        return Container();
                      }
              ...
              onTap: () {
                if (_userValidationCubit!.passwordError.isEmpty &&
                  ...
                  _usersBloc!.add(EditUsersEvent(
                      ...
                      ruleType: _ruleType));
                  _usersBloc!.add(ResetUsersEvent());
