...
class BackgroundShapesMobile extends StatefulWidget {
  const BackgroundShapesMobile({super.key});

  @override
  State<BackgroundShapesMobile> createState() => _BackgroundShapesMobileState();
}

class _BackgroundShapesMobileState extends State<BackgroundShapesMobile>
        ...
        children: [
          Positioned(
              ...
              child: SlideTransition(
                  ...
                  child: Image.asset(Assets.mobileCircle_1))),
          Positioned(
              bottom: 0,
              right: 0,
              child: SlideTransition(
                  position: circleTwoAnimation,
                  child: Image.asset(Assets.mobileCircle_2))),
          Positioned(
              top: 12,
              left: 12,
              child: SlideTransition(
                  position: circleThreeAnimation,
                  child: Image.asset(Assets.mobileCircle_3))),
          Positioned(
              top: 0,
              right: 0,
              child: SlideTransition(
                  position: circleFourAnimation,
                  child: Image.asset(Assets.mobileCircle_4))),
        ],
      ),
    );
  }
